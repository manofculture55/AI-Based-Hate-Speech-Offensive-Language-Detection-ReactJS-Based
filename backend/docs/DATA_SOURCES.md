...
## 1. Dataset Sources
This project integrates the following publicly available research datasets:
...
4.  **Label Mapping:** Standardized all source labels to the project's label schema:
